...
public class UserServiceImpl implements UserService {
    ...
    // String text = String.format("Hola %s, confirma tu cuenta ingresando el
    // siguiente codigo: %s", user.getName(),
    // codigo);
    // sendConfirmationEmail(user, token, passwordRaw);
    ...
    // String text = String.format("Hola %s, confirma tu cuenta nuevamente
    // ingresando el siguiente codigo: %s",
    // user.getName(), codigo);
